...
public class TexturePacker {
	...
	public static final void installComponent (final TexturePackerComponent component_to_install) {
	...
	public static Packer newPacker (final TexturePackingSpecs packing_specs) {
